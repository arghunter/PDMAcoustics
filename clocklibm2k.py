...
# AnalogOut setup
print(aout.getMaximumSamplerate(clock_ch))
aout.setCyclic(True)
aout.enableChannel(clock_ch, True)
aout.setSampleRate(clock_ch, clock_frequency*number_of_samples)
# oversampling_ratio = max_dac_sample_rate/(clock_frequency * number_of_samples)
# oversampling_ratio = max_dac_sample_rate / (clock_frequency * number_of_samples)
# print(f"Oversampling Ratio: {oversampling_ratio}")
# actual_clock_frequency = max_dac_sample_rate / (oversampling_ratio * number_of_samples)
# print(f"Expected Clock Frequency: {clock_frequency} Hz")
# print(f"Actual Clock Frequency: {actual_clock_frequency} Hz")
