...
data[0]=get_data("./Acoustics/PDMTests/186/output_bit_1.txt",0,length)
print("Stream 1 Complete")
data[1]=get_data("./Acoustics/PDMTests/186/output_bit_1.txt",1,length)
print("Stream 2 Complete")
data[2]=get_data("./Acoustics/PDMTests/186/output_bit_2.txt",0,length)
print("Stream 3 Complete")
data[3]=get_data("./Acoustics/PDMTests/186/output_bit_2.txt",1,length)
print("Stream 4 Complete")
data[4]=get_data("./Acoustics/PDMTests/186/output_bit_3.txt",0,length)
print("Stream 5 Complete")
data[5]=get_data("./Acoustics/PDMTests/186/output_bit_3.txt",1,length)
print("Stream 6 Complete")
data[6]=get_data("./Acoustics/PDMTests/186/output_bit_4.txt",0,length)
print("Stream 7 Complete")
data[7]=get_data("./Acoustics/PDMTests/186/output_bit_4.txt",1,length)
print("Stream 8 Complete")
data[8]=get_data("./Acoustics/PDMTests/186/output_bit_8.txt",0,length)
print("Stream 9 Complete")
data[9]=get_data("./Acoustics/PDMTests/186/output_bit_8.txt",1,length)
print("Stream 10 Complete")
data[10]=get_data("./Acoustics/PDMTests/186/output_bit_9.txt",0,length)
print("Stream 11 Complete")
data[11]=get_data("./Acoustics/PDMTests/186/output_bit_9.txt",1,length)
print("Stream 12 Complete")
data[12]=get_data("./Acoustics/PDMTests/186/output_bit_10.txt",0,length)
print("Stream 13 Complete")
data[13]=get_data("./Acoustics/PDMTests/186/output_bit_10.txt",1,length)
print("Stream 14 Complete")
data[14]=get_data("./Acoustics/PDMTests/186/output_bit_11.txt",0,length)
print("Stream 15 Complete")
data[15]=get_data("./Acoustics/PDMTests/186/output_bit_11.txt",1,length)
print("Stream 16 Complete")
print("Data Collected")
import os
for i in range(16):
    output_file = os.path.join("./Acoustics/PDMTests/186/", f"bitstreamstream_{i}.txt")
...
write("./Acoustics/PDMTests/186/data.wav", 48000,outdata.T)
